...
async function mostrarProductos() { // uso async xq en la funcion exportada va async tambien
...
async function confirmarEliminar(e) {
    if (e.target.classList.contains('eliminar')) { //veo que trae el evento con e y target para aupuntar la classe que contiene eliminar
